...
export const TryStacklyBanner = () => (
  <div className="relative bg-green-folders bg-[bottom_0rem_right_-2.5rem] max-w-6xl mx-auto md:bg-[length:63%] lg:bg-[length:65%] md:bg-[top_-2rem_right_-16rem] lg:bg-[top_-2rem_right_-12rem]  xl:bg-[top_-5rem_right_-12rem] bg-no-repeat shadow-lg p-6 pb-12 md:p-14 bg-primary-900 rounded-3xl md:bg-coins border border-black/90">
