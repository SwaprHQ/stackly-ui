...
export const TryStacklyBanner = () => (
  <div className="relative bg-green-folders bg-[bottom_0rem_right_-4.4rem] sm:bg-[bottom_0rem_right_-1.5rem] mx-auto md:bg-[length:63%] lg:bg-[length:65%] md:bg-[top_-2rem_right_-16rem] lg:bg-[top_-2rem_right_-12rem]  xl:bg-[top_-7rem_right_-6rem] bg-no-repeat shadow-lg p-6 pb-12 md:p-14 bg-primary-900 rounded-[20px] md:rounded-[40px] md:bg-coins">
